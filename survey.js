          ...
          rl.question(" What's your favourite thing to eat for that meal? ", (answer) => {
            ...
            rl.question(" Which sport is your absolute favourite?", (answer) => {
              ...
              rl.question("What is your superpower? In a few words, tell us what you are amazing at! ", (answer) => {
                ...
                console.log(`My name is ${inputAnswers.name} and I like to ${inputAnswers.activity} while listening to ${inputAnswers.listen}. My favorite meal is ${inputAnswers.meal} and my favorite food to eat is ${inputAnswers.food} for ${inputAnswers.meal}. My favorite sport is ${inputAnswers.sport}. If I could have a superpower it would be ${inputAnswers.superpower} `)
                rl.close()
